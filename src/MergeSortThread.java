...
public class MergeSortThread {
    ...
    private static class MergeSort implements Runnable {
        private int[] arr;
        private int start;
        private int end;
        ...
        public void run() {
            ...
            int mid = (start + end) / 2;
            MergeSort left = new MergeSort(arr, start, mid);
            MergeSort right = new MergeSort(arr, mid, end);
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            MergeSort task = new MergeSort(arr, 0, arr.length);
